...
public class AuthenticationAspects {
    ...
    @Pointcut("execution(@com.colossus.todolist.annotations.Authenticational * *(..) )")
    ...
    public Object around (ProceedingJoinPoint joinPoint){
        ...
        if (request == null){
            throw new RuntimeException("Method annotated @Authenticational must have a HttpServletRequest argument");
        }
        ...
        return authenticationUtils.performAfterAuthentication(request, (userId) -> {
            try{
                ...
                throw new RuntimeException("Class annotated @Authenticational must have an userId field", e);
